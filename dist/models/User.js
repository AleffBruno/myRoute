...
var User = /** @class */ (function () {
    ...
    User.validateRules = function (req, res, next) {
    ...
    User.returnRules = function () {
        ...
        return [
            check_1.check('email').isEmail()
                ...
                .custom(new User_1().uniqueEmail),
            check_1.check('password').isLength({ min: 5 })
        ];
    };
    ...
    //     }
    // }
    User.prototype.uniqueEmail = function (email) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, typeorm_2.getRepository(User_1).findOne({ email: email })];
                    case 1:
                        user = _a.sent();
                        if (user) {
                            return [2 /*return*/, Promise.reject('e-mail ja existe')];
                        }
                        return [3 /*break*/, 3];
                    case 2:
                        err_1 = _a.sent();
